...
impl Ui {
    ...
    pub fn begin_popup_context_item(&self) -> Option<PopupToken<'_>> {
        let render = unsafe {
            sys::igBeginPopupContextItem(std::ptr::null(), imgui_sys::ImGuiPopupFlags_MouseButtonRight as i32)
        };
    ...
    #[doc(alias = "BeginPopupContextItem")]
    pub fn begin_popup_context_item_id<Label: AsRef<str>>(&self, str_id: Label) -> Option<PopupToken<'_>> {
        let render = unsafe {
            sys::igBeginPopupContextItem(self.scratch_txt(str_id), imgui_sys::ImGuiPopupFlags_MouseButtonRight as i32)
        };
    ...
    pub fn begin_popup_context_window<Label: AsRef<str>>(&self, str_id: Label) -> Option<PopupToken<'_>> {
        let render = unsafe {
            sys::igBeginPopupContextWindow(self.scratch_txt(str_id), imgui_sys::ImGuiPopupFlags_MouseButtonRight as i32)
        };
    ...
    pub fn begin_popup_context_void<Label: AsRef<str>>(&self, str_id: Label) -> Option<PopupToken<'_>> {
        let render = unsafe {
            sys::igBeginPopupContextWindow(self.scratch_txt(str_id), imgui_sys::ImGuiPopupFlags_MouseButtonRight as i32)
        };
